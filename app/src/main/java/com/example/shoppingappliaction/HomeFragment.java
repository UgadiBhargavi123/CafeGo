...
public class HomeFragment extends Fragment implements CoffeeName,ParticularCoffeeDetails {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        searchListRecyclerVIew = new SearchListRecyclerVIew(getContext(), searchCoffeePojoClassArrayList, this);
        ...
        particularCoffeeDetails_recyclerview.setLayoutManager(new GridLayoutManager(getContext(), 2));
        return view;
    }
    @Override
    public void setcoffeeName(String coffeeName, boolean fromSearchList) {
        ...
        if (particularCoffeeRecyclerViewAdapter == null) {
            particularCoffeeRecyclerViewAdapter = new ParticularCoffeeRecyclerView(detailsCoffeePojoClassArrayList, getContext(),  this);
